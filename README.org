...
* Usage
Depends on [[https://github.com/atomontage/osa][osa.el]] which needs to be installed.

#+BEGIN_SRC emacs-lisp
M-x osa-chrome

C-h m ; to see default keybindings.
#+END_SRC
...
and Safari does not expose unique ids for tabs. Writing a similar mode for Safari
is possible but absence of unique ids means more complicated code, and since I am
not using it at all, I have no incentive to support it.
